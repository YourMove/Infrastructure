...
var Warehouser = {
	...
	Send: function () {
		...
		// Send request
		Warehouser.RequestObject.open('POST', Warehouser.Connection.API, true);
		Warehouser.RequestObject.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
		Warehouser.RequestObject.send(Warehouser.Current.JSON);
...
if (Warehouser.Monitoring.Immediate === true) Warehouser.StartMonitoring();
