<html>
	...
	<!-- Warehouser / Specification/1/Tests/1/TestClient.html - A simple Warehouser skeleton
		...
		<script type="text/javascript">
			...
			console.log('YMI: Performing test - With Vector and Record, but empty Data. Success if writes a new revision to specific record in vector.');
		...
		<script type="text/javascript">
			...
			var Test = function () {
				...
				if (typeof Warehouser !== 'undefined') {
					...
					console.log(Warehouser.Write('Test Test', 'VectorPart', 5));
