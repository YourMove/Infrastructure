<html>
	...
	<!-- Warehouser / Specification/1/Tests/1/TestClient.html - A simple Warehouser skeleton
		...
		<script type="text/javascript">
			...
			console.log('YMI: Performing test - 12.AC.2 - 1 read and 1 write with vector and record only.');
		...
		<script type="text/javascript">
			...
			var Test = function () {
				...
				if (typeof Warehouser !== 'undefined') {
					...
					console.log('YMI: Warehouser loaded, running test 12.AC.2..');
					console.log(Warehouser.Read('VectorPart', 2));
					console.log(Warehouser.Write('', 'VectorPart', 2));
